...
export default function AdminControlRoom(){
 ...
 return <main className="synora-shell"><div className="grid-bg"/><div className="scanlines"/><header className="topbar"><div className="brand"><span className="brand-mark">S</span> SYNORA <i>//</i> CONTROL ROOM</div><div className="top-actions"><div className="status"><span className="dot"/> TEACHER NODE · LIVE</div><a className="ghost-btn" href="/synora">MAPPA</a></div></header>
 <section className="dashboard admin-dashboard"><div className="eyebrow">TEACHER CONTROL // LIVE MONITOR</div><h1 className="dash-title">La rete sotto controllo.</h1><p className="admin-subtitle">Monitoraggio delle squadre, punteggi e avanzamento. Aggiornamento automatico ogni 10 secondi.</p>
