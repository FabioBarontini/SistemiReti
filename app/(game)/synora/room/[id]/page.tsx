...
export default async function RoomPage({ params }: { params: Promise<{id:string}> }) {
  ...
  const { error: startError } = await supabase.rpc('start_room',{p_user_id:user.id,p_room_id:roomId})
  if (startError) console.error('SYNORA start_room:', startError.message)
